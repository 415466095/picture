...
#训练好的模型是哪个 我可以测试我这边的图片吗，这个weights下面的nasnet文件就是模型，可以，直接把图片放在dir文件夹下；images下的是？那个直接删除就好了
# path to the images and the text file which holds the scores and ids 加载数据集
base_images_path = r'/home/hadoop/文档/毕设/Access/AVA/model1/'
ava_dataset_path = r'/home/hadoop/文档/毕设/Access/AVA/model1s.txt'
...
with open(ava_dataset_path, mode='r') as f:
    ...
    for i, line in enumerate(lines):
        ...
        if i % count == 0 and i != 0:
            print('Loaded %d percent of the dataset' % (i / 40097. * 100))
